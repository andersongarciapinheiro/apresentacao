...
function loadEnablerInfos(){
    ...
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S1_BG.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s1_bg.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S1_PRODUTO = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S1_PRODUTO.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s1_produtos.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S1_SPRITE = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S1_SPRITE.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/sprite.png";
    ...
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S2_BG.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s2_bg.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S1_PRODUTO_2 = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S1_PRODUTO_2.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s2_produtos.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S2_FOTO = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S2_FOTO.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/empty.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S2_TXT = "<font style=\'color:#ffffff; font-family:typography_bold\'>Seu make vegano e ecofriendly para curtir um <\/font><font style=\'color:#30355d; font-family:typography_black_italic\'>#Carnaval Consciente <\/font>";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S3_BG = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S3_BG.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s3_bg.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S3_PRODUTO = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S3_PRODUTO.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s3_produtos.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S3_SELO = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S3_SELO.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s3_selo.png";
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S4_BG = {};
    devDynamicContent.Feed_Boticario_Intense_Feed_Msg_1[0].S4_BG.Url = "http://dev.amad.re/almap/boticario/dco/intense/300x250/v4/s4_bg.png";
...
timeline.animationElements('s2_bg1_classMotion_0', [['.s2_bg1', timerSteps[0]]]);
...
if(controleSelo){
    timeline.animationElements('s3_bg1_classMotion_0', [['.s3_bg1', timerSteps[1]]]);
